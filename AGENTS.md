...
- **Aim is the engine.** Hand tracking (`proto/hands.js` `mpTrack` / Worker `detectForVideo` / `fallbackSkin`) and HID fire first. Prefer that over maps, net, Steam, or anti-cheat.
