...
def test_round_trip() -> None:
    ...
    if "seed" in warm or warm.get("plates") or warm.get("scores") or warm.get("shots") or warm.get("combo_max"):
...
def test_practice_never_promotes() -> None:
    ...
    if g.get("seed") or g.get("plates") or g.get("scores") or g.get("shots") or g.get("combo_max"):
