...
Open http://127.0.0.1:8080 — allow camera, raise a hand, point, thumb UP (shark-fin) to fire. Thumb parallel is SAFE. Index+middle ceiling reloads (charger-plug). Pad is menus / DESKTOP emergency only.
