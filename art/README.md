...
Do not import third-party game FBX, Marketplace packs, or scans. SablePort fails loud if runtime art grows foreign title / map / pack strings (`tools/test_sableport.py`).
