...
v1 modes: offline **Gallery** (Salt House 60s on the Yard), waiting-arena **WARM UP** / **ENTER RANGE**. Bay 1v1 is parked (code stays; not player-facing). Playlist: `docs/modes.md`. Later-migrate seams (feeling / architecture only): `docs/port.md`.
