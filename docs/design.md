...
v1 modes: offline **Gallery** (Salt House 60s), **Bay** 1v1 on the R6 tick (128 Hz pose, HID fire outside, `fire_ms` stamp; lobby **ENTER BAY** is room-owned), waiting-arena **WARM UP** / **ENTER RANGE**. Playlist: `docs/modes.md`. Later-migrate seams (feeling / architecture only): `docs/port.md`.
