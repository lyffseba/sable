...
- Point the index finger at the screen. **Shark-fin** (thumb UP) is product fire on the hand path. Thumb parallel to the other fingers is safe. Trackpad click is DESKTOP / pad fallback. Pinch (thumb↔index) stays interim.
