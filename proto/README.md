...
1. **OFFLINE** (60s gallery on the Yard) or **ONLINE** (HUD-on-Yard always-practice, camera armed without lock) → **WARM UP** / **ENTER RANGE** (shared live Yard, skip calib/lock when already lifted). Bay booth is parked.
